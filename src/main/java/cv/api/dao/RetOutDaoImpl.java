...
public class RetOutDaoImpl extends AbstractDao<RetOutHisKey, RetOutHis> implements RetOutDao {
    ...
    public void delete(RetOutHisKey key) throws Exception {
        ...
        String sql = "update ret_out_his set deleted = true,intg_upd_status = null where vou_no ='" + vouNo + "' and comp_code='" + compCode + "' and dept_id =" + deptId + "";
        execSql(sql);
    }
    ...
    public void restore(RetOutHisKey key) throws Exception {
        ...
        String compCode = key.getCompCode();
        Integer deptId = key.getDeptId();
        String sql = "update ret_out_his set deleted = false,intg_upd_status = null where vou_no ='" + vouNo + "' and comp_code='" + compCode + "' and dept_id =" + deptId + "";
        execSql(sql);
    }
