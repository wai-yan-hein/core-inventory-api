...
@Repository
@Slf4j
public class OrderHisDetailDaoImpl extends AbstractDao<SaleDetailKey, OrderHisDetail> implements OrderHisDetailDao {
...
//                    key.setSdCode(rs.getString("sd_code"));
    ...
    @Override
    public int delete(String vouNo, Integer uniqueId, String compCode, Integer deptId) {
        String strSql = "delete from order_his_detail where vou_no = '" + vouNo + "' and unique_id = " + uniqueId + " and comp_code ='" + compCode + "' and dept_id =" + deptId + "";
        execSQL(strSql);
        return 1;
    }

    @Override
    public List<OrderHisDetail> getOrderByBatch(String batchNo, String compCode, Integer deptId) {
        List<OrderHisDetail> listOP = new ArrayList<>();
    ...
    @Override
    public List<OrderHisDetail> getOrderByBatchDetail(String batchNo, String compCode, Integer deptId) {
        List<OrderHisDetail> listOP = new ArrayList<>();
        String sql = "select a.*,a.qty*a.sale_price sale_amt,s.user_code s_user_code,s.stock_name,rel.rel_name,l.loc_name\n" +
                "from (\n" +
