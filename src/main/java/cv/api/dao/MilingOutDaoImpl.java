...
@Repository
@Slf4j
public class MilingOutDaoImpl extends AbstractDao<MilingOutDetailKey, MilingOutDetail> implements MilingOutDao {
    ...
    public List<MilingOutDetail> search(String vouNo, String compCode, Integer deptId) {
        List<MilingOutDetail> listOP = new ArrayList<>();
        ...
        if (rs != null) {
            try {
                ...
                while (rs.next()) {
                    MilingOutDetail op = new MilingOutDetail();
    ...
    @Override
    public List<MilingOutDetail> searchDetail(String vouNo, String compCode, Integer deptId) {
        List<MilingOutDetail> list = new ArrayList<>();
        //sd_code, vou_no, stock_code, expire_date, qty, sale_unit, sale_price, sale_amt, loc_code, unique_id, comp_code, dept_id
        ...
        try {
            ...
            if (rs != null) {
                while (rs.next()) {
                    MilingOutDetail sh = new MilingOutDetail();
                    MilingOutDetailKey key = new MilingOutDetailKey();
                    key.setDeptId(rs.getInt("dept_id"));
                    key.setCompCode(rs.getString("comp_code"));
                    key.setUniqueId(rs.getInt("unique_id"));
    ...
    @Override
    public List<MilingOutDetail> getSaleByBatch(String batchNo, String compCode, Integer deptId) {
        List<MilingOutDetail> listOP = new ArrayList<>();
    ...
    @Override
    public List<MilingOutDetail> getSaleByBatchDetail(String batchNo, String compCode, Integer deptId) {
        List<MilingOutDetail> listOP = new ArrayList<>();
