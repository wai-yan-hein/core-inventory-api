...
public class ReportService {
    ...
    public Flux<VOrder> getOrderVoucher(String vouNo, String compCode) {
        String sql = """
    ...
    public Mono<ReturnObject> getOrderByStockSummary(String fromDate, String toDate, String curCode, String stockCode, String typeCode, String brandCode, String catCode, String locCode, String compCode, Integer deptId, Integer macId) {
        ...
        return client.sql(sql)
                ...
                .map(row -> {
                    ...
                    sale.setSaleAmount(row.get("ttl_amt", Double.class));
...
//                  s.setBatchNo(row.get("batch_no", String.class));
                    ...
                    s.setQty(row.get("qty", Double.class));
                    s.setSaleUnit(row.get("unit", String.class));
                    s.setSalePrice(row.get("price", Double.class));
                    s.setSaleAmount(row.get("amt", Double.class));
                    s.setVouTotal(row.get("vou_total", Double.class));
                    s.setPaid(row.get("paid", Double.class));
                    return s;
                })
    ...
    public Mono<ReturnObject> getOrderByStockDetail(String fromDate, String toDate, String curCode, String stockCode, String typeCode, String brandCode, String catCode, String locCode, String compCode, Integer macId) {
        ...
        return client.sql(sql)
                ...
                .map(row -> {
                    ...
                    sale.setSalePrice(row.get("price", Double.class));
                    sale.setSaleAmount(row.get("amt", Double.class));
                    return sale;
                })
                .all()
                .collectList()
    ...
    public Mono<ReturnObject> getOrderByDueDate(String fromDueDate, String toDueDate, String curCode, String stockCode, String typeCode,
                                                String brandCode, String catCode, String locCode, String batchNo, String compCode,
                                                Integer deptId, Integer macId) {
        String filter = "";
        if (!fromDueDate.equals("-") && !toDueDate.equals("-")) {
        ...
        return client.sql(sql)
                ...
                .map(row -> {
                    ...
                    order.setCreditTerm(Util1.toDateStr(row.get("credit_term", LocalDate.class), "dd/MM/yyyy"));
                    order.setVouNo(row.get("vou_no", String.class));
                    order.setTraderName(row.get("trader_name", String.class));
                    order.setVouTotal(row.get("vou_total", Double.class));
                    return order;
                })
                .all()
                .collectList()
    ...
    public Mono<ReturnObject> getOrderByDueDateDetail(String fromDueDate, String toDueDate, String curCode, String stockCode, String typeCode,
                                                      String brandCode, String catCode, String locCode, String batchNo, String compCode,
                                                      Integer deptId, Integer macId) {
        String filter = "";
        if (!typeCode.equals("-")) {
        ...
        String sql = """
                select v.credit_term,v.vou_date,v.vou_no,v.vou_total,v.paid,v.remark,v.reference,sup.trader_name sup_name,
        ...
        return client.sql(sql)
                ...
                .map(row -> {
                    ...
                    order.setCreditTerm(Util1.toDateStr(row.get("credit_term", LocalDate.class), "dd/MM/yyyy"));
                    order.setVouNo(row.get("vou_no", String.class));
                    order.setRemark(row.get("remark", String.class));
                    order.setReference(row.get("reference", String.class));
                    order.setTraderCode(row.get("user_code", String.class));
                    order.setTraderName(row.get("trader_name", String.class));
                    order.setCusAddress(row.get("address", String.class));
                    order.setStockUserCode(row.get("s_user_code", String.class));
                    order.setStockName(row.get("stock_name", String.class));
                    order.setQty(row.get("qty", Double.class));
                    order.setSaleUnit(row.get("unit", String.class));
                    order.setSalePrice(row.get("price", Double.class));
                    order.setSaleAmount(row.get("amt", Double.class));
                    order.setVouTotal(row.get("vou_total", Double.class));
                    order.setPaid(row.get("paid", Double.class));
                    return order;
                })
                .all()
                .collectList()
    ...
    public Flux<VOrder> getOrderSummaryByDepartment(String fromDate, String toDate, String compCode) {
        String sql = """
    ...
    public Flux<MillingHis> getMillingHistory(String fromDate, String toDate, String traderCode, String vouNo, String remark, String reference, String userCode, String stockCode, String locCode,
        ...
        return client.sql(sql)
                ...
                .map(row -> {
                    ...
                    s.setKey(key);
                    s.setVouDateStr(Util1.toDateStr(row.get("vou_date", LocalDate.class), "dd/MM/yyyy"));
                    s.setVouDateTime(Util1.toZonedDateTime(row.get("vou_date", LocalDateTime.class)));
                    s.setTraderName(row.get("trader_name", String.class));
                    s.setProcessType(row.get("description", String.class));
                    s.setRemark(row.get("remark", String.class));
                    s.setReference(row.get("reference", String.class));
