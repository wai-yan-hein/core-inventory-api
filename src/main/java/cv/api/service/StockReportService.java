        ...
        return client.sql(sql)
                ...
                .map((row) -> {
                    var cl = ClosingBalance.builder()
                            ...
                            .balBag(row.get("bal_bag", Double.class))
                            .openWet(row.get("avg_op_wet", Double.class))
                            .purWet(row.get("avg_pur_wet", Double.class))
                            .purWetTotal(row.get("pur_wet", Double.class))
                            .inWet(row.get("avg_in_wet", Double.class))
                            .inWetTotal(row.get("in_wet", Double.class))
                            .saleWet(row.get("avg_sale_wet", Double.class))
                            .outWet(row.get("avg_out_wet", Double.class))
                            .balWet(row.get("avg_bal_wet", Double.class))
                            .openRice(row.get("avg_op_rice", Double.class))
                            .purRice(row.get("avg_pur_rice", Double.class))
                            .purRiceTotal(row.get("pur_rice", Double.class))
                            .inRice(row.get("avg_in_rice", Double.class))
                            .inRiceTotal(row.get("in_rice", Double.class))
                            .saleRice(row.get("avg_sale_rice", Double.class))
                            .outRice(row.get("avg_out_rice", Double.class))
                            .balRice(row.get("avg_bal_rice", Double.class))
                            .opPrice(row.get("op_price", Double.class))
                            .purPrice(row.get("pur_price", Double.class))
                            .purPriceTotal(row.get("pur_ttl_amt", Double.class))
                            .inPrice(row.get("in_price", Double.class))
                            .inPriceTotal(row.get("in_ttl_amt", Double.class))
                            .outPrice(row.get("out_price", Double.class))
